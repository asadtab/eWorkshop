...
StanicaUredjaj _$StanicaUredjajFromJson(Map<String, dynamic> json) => StanicaUredjaj()
  ..id = json['id'] as int
...
Map<String, dynamic> _$StanicaUredjajToJson(StanicaUredjaj instance) => <String, dynamic>{
      'id': instance.id,
