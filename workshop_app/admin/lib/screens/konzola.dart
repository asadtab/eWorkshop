...
class _KonzolaScreenState extends State<KonzolaScreen> {
  ...
  void initState() {
    ...
    widget.refreshKonzolaCallback?.call();
  }
        ...
        body: SafeArea(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Padding(
                ...
                child: Row(
                    children: radniZadatakDetalj
                        .map((e) => RadniZadaciWidget(
                              radniZadatakUredjaj: radniZadatakUredjajData.where((uredjaj) => uredjaj.radniZadatakId == e.radniZadatakId).toList(),
                              radniZadatak: e,
                            ))
                        .toList())),
            Container(
