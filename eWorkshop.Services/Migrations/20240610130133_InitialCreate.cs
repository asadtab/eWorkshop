    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2024, 6, 10, 15, 1, 32, 533, DateTimeKind.Local).AddTicks(8245), "Api", "api", true, null, "api", false, false, true, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 10, 15, 1, 32, 537, DateTimeKind.Local).AddTicks(2574), "Pristup informacijama o korisniku", "Pristup", false, true, null, "profile", false, false, false, null },
                    { 2, new DateTime(2024, 6, 10, 15, 1, 32, 537, DateTimeKind.Local).AddTicks(2646), "Pristup e-mail adresama korisnika", "Email", false, true, null, "email", false, false, false, null },
                    { 3, new DateTime(2024, 6, 10, 15, 1, 32, 537, DateTimeKind.Local).AddTicks(2660), "Potreban je OpenID Connect, zahtijeva osnovne informacije o korisniku", "OpenID", false, true, null, "openid", false, false, false, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Korisnici",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "Ime", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Prezime", "SecurityStamp", "Status", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { 1, 0, "4bf2a5ec-6447-44fb-993a-8ec9b854b64e", "asad.admin@tab.ba", true, "Asad", false, null, "ASAD.ADMIN@TAB.BA", "ASAD.ADMIN", "AQAAAAEAACcQAAAAEOrxB0V96lsHoUhOZJRVnByCxcZnI3HJ5qRY1M0D0A/9T/bfpoT8/Sh3ioZZUlfWsA==", null, false, "Admin", "PDKUYGIUAOVZBNHYEGVK6WMHA2IGLZHZ", true, false, "asad.admin" },
                    { 2, 0, "4bf2a5ec-6447-44fb-993a-8ec9b854b64e", "asad.serviser@tab.ba", true, "Asad", false, null, "ASAD.SERVISER@TAB.BA", "ASAD.SERVISER", "AQAAAAEAACcQAAAAEOrxB0V96lsHoUhOZJRVnByCxcZnI3HJ5qRY1M0D0A/9T/bfpoT8/Sh3ioZZUlfWsA==", null, false, "Serviser", "PDKUYGIUAOVZBNHYEGVK6WMHA2IGLZHZ", true, false, "asad.serviser" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 6, 10, 15, 1, 32, 562, DateTimeKind.Local).AddTicks(3397), "Mostar", "active" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2024, 6, 10, 15, 1, 32, 557, DateTimeKind.Local).AddTicks(5480), "Aplikacija", new DateTime(2025, 2, 4, 9, 39, 35, 109, DateTimeKind.Unspecified), "app", "flutter" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 10, 15, 1, 32, 569, DateTimeKind.Local).AddTicks(4517), 1, null, 1, 189 },
                    { 2, new DateTime(2024, 6, 10, 15, 1, 32, 569, DateTimeKind.Local).AddTicks(4588), 1, null, 1, 190 },
                    { 3, new DateTime(2024, 6, 10, 15, 1, 32, 569, DateTimeKind.Local).AddTicks(4596), 2, null, 1, 191 },
                    { 4, new DateTime(2024, 6, 10, 15, 1, 32, 569, DateTimeKind.Local).AddTicks(4602), 2, null, 1, 192 },
                    { 5, new DateTime(2024, 6, 10, 15, 1, 32, 569, DateTimeKind.Local).AddTicks(4618), 1, null, 1, 193 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 10, 13, 1, 32, 560, DateTimeKind.Utc).AddTicks(4101), 1, null, null, null, 1 },
                    { 2, new DateTime(2024, 6, 10, 13, 1, 32, 560, DateTimeKind.Utc).AddTicks(4109), 2, null, null, null, 1 },
                    { 3, new DateTime(2024, 6, 10, 13, 1, 32, 560, DateTimeKind.Utc).AddTicks(4113), 1, null, null, null, 2 },
                    { 4, new DateTime(2024, 6, 10, 13, 1, 32, 560, DateTimeKind.Utc).AddTicks(4114), 3, null, null, null, 2 },
                    { 5, new DateTime(2024, 6, 10, 13, 1, 32, 560, DateTimeKind.Utc).AddTicks(4111), 3, null, null, null, 1 }
                });
