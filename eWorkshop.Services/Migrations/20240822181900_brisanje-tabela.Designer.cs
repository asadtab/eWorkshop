...
namespace eWorkshop.Services.Migrations
{
    ...
    [Migration("20240822181900_brisanje-tabela")]
    partial class brisanjetabela
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.ApiResource", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 8, 22, 20, 18, 58, 972, DateTimeKind.Local).AddTicks(5728),
                            Description = "Api",
                            DisplayName = "api",
                            Enabled = true,
                            Name = "api",
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.ApiScope", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2024, 8, 22, 20, 18, 58, 974, DateTimeKind.Local).AddTicks(1375),
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2024, 8, 22, 20, 18, 58, 974, DateTimeKind.Local).AddTicks(1490),
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2024, 8, 22, 20, 18, 58, 974, DateTimeKind.Local).AddTicks(1499),
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2024, 8, 22, 20, 18, 58, 986, DateTimeKind.Local).AddTicks(5448),
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.IzvrseniServi", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IzvrseniServisId = 1,
                            Datum = new DateTime(2024, 8, 22, 18, 18, 58, 987, DateTimeKind.Utc).AddTicks(8801),
                            KomponentaId = 1,
                            ServisId = 1
                        },
                        new
                        {
                            IzvrseniServisId = 2,
                            Datum = new DateTime(2024, 8, 22, 18, 18, 58, 987, DateTimeKind.Utc).AddTicks(8805),
                            KomponentaId = 2,
                            ServisId = 1
                        },
                        new
                        {
                            IzvrseniServisId = 5,
                            Datum = new DateTime(2024, 8, 22, 18, 18, 58, 987, DateTimeKind.Utc).AddTicks(8807),
                            KomponentaId = 3,
                            ServisId = 1
                        },
                        new
                        {
                            IzvrseniServisId = 3,
                            Datum = new DateTime(2024, 8, 22, 18, 18, 58, 987, DateTimeKind.Utc).AddTicks(8808),
                            KomponentaId = 1,
                            ServisId = 2
                        },
                        new
                        {
                            IzvrseniServisId = 4,
                            Datum = new DateTime(2024, 8, 22, 18, 18, 58, 987, DateTimeKind.Utc).AddTicks(8810),
                            KomponentaId = 3,
                            ServisId = 2
                        });
                });
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.RadniZadatak", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RadniZadatakId = 1,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 988, DateTimeKind.Local).AddTicks(8375),
                            Naziv = "Mostar",
                            StateMachine = "active"
                        });
                });
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.Servi", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ServisId = 1,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 990, DateTimeKind.Local).AddTicks(2015),
                            KorisnikId = 1,
                            RadniZadatakId = 1,
                            UredjajId = 189
                        },
                        ...
                        {
                            ServisId = 2,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 990, DateTimeKind.Local).AddTicks(2043),
                            KorisnikId = 1,
                            RadniZadatakId = 1,
                            UredjajId = 190
                        },
                        ...
                        {
                            ServisId = 3,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 990, DateTimeKind.Local).AddTicks(2047),
                            KorisnikId = 2,
                            RadniZadatakId = 1,
                            UredjajId = 191
                        },
                        ...
                        {
                            ServisId = 4,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 990, DateTimeKind.Local).AddTicks(2051),
                            KorisnikId = 2,
                            RadniZadatakId = 1,
                            UredjajId = 192
                        },
                        ...
                        {
                            ServisId = 5,
                            Datum = new DateTime(2024, 8, 22, 20, 18, 58, 990, DateTimeKind.Local).AddTicks(2060),
                            KorisnikId = 1,
                            RadniZadatakId = 1,
                            UredjajId = 193
                        });
            ...
            modelBuilder.Entity("eWorkshop.Services.Database.Uloge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "ecce9232-b581-4153-ae3a-26bd03c035ba",
                            Name = "Administrator",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "0a02c9b8-3f48-4934-8906-dbca5590ef8e",
                            Name = "Serviser",
